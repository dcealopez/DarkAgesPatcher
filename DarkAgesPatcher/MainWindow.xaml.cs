    ...
    public partial class MainWindow : Window
    {
        ...
        private void PatchButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            var openFileDialog = new OpenFileDialog()
            {
                ...
                FilterIndex = 1,
                Multiselect = false,
                FileName = "DOOMTheDarkAges.exe",
                Title = "Open DOOM: The Dark Ages game executable file (.exe)"
            };
        ...
        private void Patch(string filePath)
        {
            ...
            if (makeBackup == MessageBoxResult.Yes)
            {
                var saveFileDialog = new SaveFileDialog()
                {
                    Filter = "All Files (.*)|*.*",
                    FilterIndex = 1,
                    FileName = "DOOMTheDarkAges.exe.bak",
                    Title = "Save DOOM: The Dark Ages game executable file backup (.bak)"
                };
